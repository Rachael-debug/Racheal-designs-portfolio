export default function Skills(){
    return(
        <ol id="skills">
            <li><i className="fa-solid fa-code"></i> Frontend Technologies: <span> HTML, CSS, JavaScript, ReactJS, TypeScript, Tailwind CSS, Sanity CMS, Styled Components</span></li>
            <li><i className="fa-solid fa-layer-group"></i> Responsive Web Design: <span> Media Queries, Flexbox, Grid</span></li>
